...
val libName = "DirectEmbroideryControl"

// The group ID of your library.
group = "com.myDomain"


// =========================================================
// Processing sketchbook location
// =========================================================

// Your actual Processing sketchbook is:
// C:\Users\3thre\OneDrive\Documents\Processing
//
// We set this manually because your Windows Documents folder
// is located inside OneDrive.

val userHome = System.getProperty("user.home")

val sketchbookLocation = "$userHome/OneDrive/Documents/Processing"
...
tasks.register("deployToProcessingSketchbook") {
    ...
    doLast {
        ...
        println(
            "Copying fresh build to sketchbook $sketchbookLocation ..."
        )
